<?php
/**
* @version   $Id: error.php 11195 2013-06-05 10:21:42Z arifin $
		...
		<div class="rt-container">
					<div class="rt-block">
						...
						<div class="rt-error-content">
							...
							<p><strong>Вы не можете попасть на эту страницу из за:</strong></p>
							<ol>
								<li>устаревшей закладки</li>
								<li>a search engine that has an out-of-date listing for this site</li>
								<li>опечатки в адресе</li>
								<li>у вас нет доступа к данному разделу</li>
								<li>запрошенный источник не был найдет</li>
								<li>Произошла ошибка при выполнении вашего запроса</li>
							</ol>
