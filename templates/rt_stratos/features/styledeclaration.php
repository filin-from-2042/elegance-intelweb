<?php
/**
* @version   $Id: styledeclaration.php 10634 2013-05-24 15:36:19Z arifin $
...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	$lessVariables = array(
            'background-color'  =>$gantry->get('background-color',  '#eef1f6'),
            'background-type'   =>$gantry->get('background-type',   'light-diagonal-strips'),
            'header-background' =>$gantry->get('header-background', '#1a1a1a'),
            'header-overlay'    =>$gantry->get('header-overlay',    'dark'),
            'main-accent'       =>$gantry->get('main-accent',       '#0099dc'),
            'main-accent2'      =>$gantry->get('main-accent2',      '#f45e5f'),
