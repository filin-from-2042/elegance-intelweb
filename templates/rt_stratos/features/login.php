<?php
/**
* @version   $Id: login.php 11746 2013-06-26 14:43:53Z arifin $
...
class GantryFeatureLogin extends GantryFeature 
{
	...
	function render($position) 
	{
	    ...
	    ?>
	    <div class="rt-popuplogin rt-block <?php global $gantry; echo 'rt-'.$gantry->get("main-body"); ?>">
			...
			<?php else : ?>
				<?php echo $this->_renderRokBoxLink(); ?>
					<span class="desc"><?php echo $this->get('logouttext'); ?></span>
				</a>				
			<?php endif; ?>
			</div>
		</div>
