...
jQuery(document).ready(function() {
	...
	// overrides
	var elements = ['layout_override', 'suffix_override', 'module_override', 'moduleid_override', 'mootools_for_pages', 'sidebar_width_for_pages'];
	...
	function getUpdates() {
		...
		var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_john_s_j30';
