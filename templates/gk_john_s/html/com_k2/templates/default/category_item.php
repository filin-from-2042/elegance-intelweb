                    ...
                    <div class="itemBody">
                              ...
                              <ul>
                                        ...
                                        <li class="itemComments">
                                                  ...
                                                  <?php else: ?>
                                                  <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor"><i class="fa fa-comments"></i><?php echo $this->item->numOfComments; ?></a>
                                                  <?php endif; ?>
                                        </li>
                                        <?php endif; ?>
                                        <?php if($this->item->params->get('catItemCategory')): ?>
                                        <li class="itemCategory"> <a href="<?php echo $this->item->category->link; ?>"><i class="fa fa-folder"></i><?php echo $this->item->category->name; ?></a> </li>
                                        <?php endif; ?>
