...
<section id="k2Container" class="latestView itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> no-bg">
	...
	<header>
  	...
  	<div class="itemContainer" style="width:<?php echo number_format(99.0/$this->params->get('latestItemsCols'), 1); ?>%;">
