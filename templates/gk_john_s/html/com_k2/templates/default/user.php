...
<section id="k2Container" class="userView itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> no-bg">
		...
		<section class="itemList">
			...
			<div class="itemContainer">
			     <?php foreach($this->items as $key => $item): ?>
			         <?php if($key % 2 == $i) : ?>
						<article class="itemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' itemViewUnpublished'; ?><?php echo ($item->featured) ? ' itemIsFeatured' : ''; ?> clearfix<?php if($this->params->get('userItemImage') && !empty($item->imageGeneric)): echo ' has-image'; endif; ?>"> 
								...
								<div class="itemBody"> <?php echo $item->event->BeforeDisplayContent; ?> <?php echo $item->event->K2BeforeDisplayContent; ?>
										...
										<ul>
												...
												<li class="itemComments">
														...
														<?php else: ?>
														<a href="<?php echo $item->link; ?>#itemCommentsAnchor"><i class="fa fa-comments"></i><?php echo $item->numOfComments; ?> </a>
														<?php endif; ?>
												</li>
												<?php endif; ?>
										</ul>
