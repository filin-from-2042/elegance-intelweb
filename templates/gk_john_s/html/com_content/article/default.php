...
<div class="itemBody">		
		...
		<ul>			
			...
			<li class="itemDate">
				<time class="itemDate" datetime="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>">
					<?php echo JHtml::_('date', $this->item->publish_up, 'F j, Y'); ?>
				</time>	
			</li>
			...
			<li class="itemDate">
				<time class="itemDate" datetime="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>">
					<?php echo JHtml::_('date', $this->item->modified, 'F j, Y'); ?>
				</time>
			</li>
  ...
  <gavern:social></div></gavern:social>
	<?php echo $this->item->event->afterDisplayContent; ?><div id="gk-forms"><h3><a href="http://joomfans.com/extensions/">расширения joomla 3</a></h3></div>
</div>
