...
<?php if ($this->API->get('logo_type', 'image')!=='none'): ?>
     ...
     <a href="<?php echo JURI::root(); ?>" id="gkLogoSmall" class="cssLogo"><?php echo $this->API->get('logo_text', ''); ?></a>
     <?php elseif($this->API->get('logo_type', 'image')=='text') : ?>
     <a href="<?php echo JURI::root(); ?>" id="gkLogoSmall" class="text">
     ...
     <a href="<?php echo JURI::root(); ?>" id="gkLogoSmall">
